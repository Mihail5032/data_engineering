 ...
 */
public class DataStreamJob_new {
    ...
    public static void main(String[] args) throws Exception {
        DataStreamJob_new job = new DataStreamJob_new();
        job.run();
    }
    ...
    public void run() throws Exception {
        ...
        // === RAW sinks — 4 сегмента без PST-логики (SourceDocument уже выше) ===
        java.util.Set<String> rawOnlySegments = java.util.Set.of(
                "E1BPLINEITEMTAX", "E1BPRETAILTOTALS",
